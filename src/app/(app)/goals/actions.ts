...
const createSchema = z.object({
  ...
  goalType: z.enum(GOAL_TYPES).default("MERIT"),
  targetPeriod: z.enum(TARGET_PERIODS).default("NONE"),
...
export async function createGoalAction(
  ...
  const parsed = createSchema.safeParse({
    ...
    goalType: formData.get("goalType") ?? "MERIT",
    targetPeriod: formData.get("targetPeriod") ?? "NONE",
